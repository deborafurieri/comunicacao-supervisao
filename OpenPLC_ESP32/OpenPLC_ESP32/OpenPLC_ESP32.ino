...
#define NODE_PIN_D0   23 //16 - Dig Out
#define NODE_PIN_D1   22 //5 - Dig Out
#define NODE_PIN_D2   1  //4 - Dig Out
#define NODE_PIN_D3   3  //0 - Dig Out
#define NODE_PIN_D4   21 //2 - Dig Input
#define NODE_PIN_D5   19 //14 - Dig Input
#define NODE_PIN_D6   18 //12 - Dig Input
#define NODE_PIN_D7   5  //13 - Dig Input
#define NODE_PIN_D8   17 //15 - Analog Out
#define NODE_PIN_A0   34 //ADC1_6 - Analog IN 
//#define NODE_PIN_A1   39 //ADC1_1 - Analog IN
...
uint8_t pinMask_AIN[] = { NODE_PIN_A0};
...
void pinConfig()
{
    ...
    analogWriteResolution(NODE_PIN_D8, 8);

    pinMode(NODE_PIN_A0, INPUT);
    analogWriteResolution(8);
    analogWriteResolution(NODE_PIN_A0, 8);
